...
extension CurrencySendViewController: CurrencySendView {
    ...
    func update(viewModel_ viewModel: CurrencySendViewModel) {
...
private extension CurrencySendViewController {
    ...
    @objc func navBarLeftActionTapped() {
        presenter.handle(event_____: CurrencySendPresenterEvent.Dismiss())
    }
}
...
private extension CurrencySendViewController {
    ...
    func onTapped(_ event: CurrencySendPresenterEvent) -> () -> Void {
        { [weak self] in self?.presenter.handle(event_____: event) }
    }
}
