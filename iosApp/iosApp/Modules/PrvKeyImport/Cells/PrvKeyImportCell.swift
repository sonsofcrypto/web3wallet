...
final class PrvKeyImportCell: ThemeCell, UICollectionViewDataSource,
    UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    typealias InputHandler = (_ mnemonic: String, _ cursorLocation: Int) -> Void

    @IBOutlet weak var textView: UITextView?

    private var viewModel: PrvKeyInputViewModel?
    ...
    func collectionView(
        ...
        0 // viewModel?.potentialWords.count ?? 0
    }
...
private extension PrvKeyImportCell {
