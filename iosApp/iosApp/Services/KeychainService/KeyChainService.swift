...
protocol OldKeyChainService: AnyObject {
    ...
    func addItem(_ item: OldKeyStoreItem) throws
    func item(for: OldKeyStoreItem) throws -> Data?
    func removeItem(_ item: OldKeyStoreItem)
...
extension DefaultKeyChainService: OldKeyChainService {
    ...
    func item(for item: OldKeyStoreItem) throws -> Data? {
...
final class OldKeyChainServiceAssembler: AssemblerComponent {
